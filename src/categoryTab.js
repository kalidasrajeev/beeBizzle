                ...
                <div style={{ width: '33.3%', border: 'none', borderRadius: '4px' }}>
                    <div style={{ margin: '10px', margin: '10px', marginLeft: '0px' }}>
                        <div style={{ width: '100%', border: 'none', position: 'relative', borderRadius: '4px' }} >
                            ...
                            <button style={{ position: 'absolute', top: '35%', left: '7%', height: '27px', width: '30%', backgroundColor: "#FFFFFF", fontSize: '11px', fontWeight: 'bold', border: 'none', borderRadius: '5%', paddingTop: '6px' }}>AED 1123</button>
                        </div>
                    </div>
                </div>
                <div style={{ width: '33.3%', border: 'none', borderRadius: '4px' }}>
