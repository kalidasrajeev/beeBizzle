...
export default function CartContent() {
    return (
        <div className='CartContainer'>
            <div className='itemsContent' style={{ paddingLeft: '50px', paddingRight: '50px', backgroundColor: '#F1F3F6' }}>
                <div className='cartItems' style={{ width: '100%' }}>
                    <div style={{ display: 'flex', width: '100%' }}>
                        <div style={{ fontSize: '12px', color: '#FFFFFF', width: '100%',paddingTop:'10px',paddingBottom:'10px' ,borderRadius:'4px' }}>
                        <div style={{ padding: '10px', paddingTop: '10px', backgroundColor: '#FFFFFF', paddingBottom: '10px', display: 'flex', color: '#212121',fontSize:'19px', fontWeight:'500' }}>
                            ...
                            <div style={{ borderBottom: '1px solid #e0e0e0' }}>
                                <div style={{ padding: '10px', paddingTop: '25px', backgroundColor: '#FFFFFF', paddingBottom: '25px', display: 'flex', color: '#FFFFFF' }}>
                                    ...
                                    <div style={{ fontSize: '14px', fontWeight: '700', color: '#212121', marginTop: '10px', padding: '3px' }}>AED 8349<span style={{ fontWeight: '600', fontSize: '11px', marginLeft: '10px', textDecoration: 'line-through' }}>AED 9000</span></div>
                                </div>
                            </div>
                        </div>
                        <div style={{ width: '40%', marginLeft: '2%', backgroundColor: '#FFFFFF',marginTop:'10px',marginBottom:'10px',borderRadius:'4px' }}>
                            <div style={{ padding: '2%' }}>
                                ...
                                <div><input type='text' style={{width:'100%',height:'56px',color:'red', margin:'1%',backgroundColor:'#F4F4F4',border:'none',borderRadius:'5px'}} placeholder="Coupen code" /></div>
