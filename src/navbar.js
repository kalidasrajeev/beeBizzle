    ...
    return (
        ...
        <div className='nav'>
            ...
            <div className='headerLinks'>
                ...
                <div className='headerLink'><div style={{ marginTop: '18px', cursor: 'pointer' }} onClick={() => handleOpen('login')}>Login</div></div>
                <div className='headerLink'>
                    <div style={{ display: 'inline-flex', position: 'relative', marginTop: '16px', cursor: 'pointer' }} onClick={handleCart}>
                        <div style={{ position: 'absolute', right: '0px', color: '#d50000', zIndex: '1', background: 'white', border: '1px solid #d50000', borderRadius: '50%', width: '14px', height: '14px', fontSize: '8px', fontWeight: '600' }}>2</div>
                    ...
                    <div style={{ display: 'inline-flex', cursor: 'pointer' }} onClick={handleCart}>Cart</div>
